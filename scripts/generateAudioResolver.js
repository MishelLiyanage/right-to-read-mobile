...
console.log(`Generated AudioResolver.ts with ${demoPages.length} Demo pages, ${grade3Pages.length} Grade 3 pages, ${grade4Pages.length} Grade 4 pages, ${grade5Pages.length} Grade 5 pages, and ${grade6Pages.length} Grade 6 pages`);
